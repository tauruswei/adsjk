...
import org.cos.common.entity.data.req.DataProjectReq;
import org.cos.common.entity.data.vo.DataProjectDetailsVo;
import org.cos.common.entity.data.vo.DataProjectListVo;
...
public class DataProjectConvert {
    ...
    public static DataProjectListVo dataProjectConvertListVo(DataProject dataProject, List<Map<String, Object>> list,Integer status){
        ...
        dataProjectListVo.setProviderOrganID(dataProject.getProviderOrganIds());
        dataProjectListVo.setProviderOrganNames(dataProject.getProviderOrganNames());
        dataProjectListVo.setProviderOrganStatus(dataProject.getProviderOrganStatus());
