package org.cos.common.config.database;
...
@Slf4j
@Configuration
@MapperScan(basePackages = "org.cos.common.repository.resourcesecondarydb",sqlSessionFactoryRef="resourceSecondarySessionFactory")
