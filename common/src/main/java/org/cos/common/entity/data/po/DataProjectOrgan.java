...
public class DataProjectOrgan {
    ...
    public DataProjectOrgan(String poId, String projectId, String organId, String initiateOrganId, Integer participationIdentity, String serverAddress , String organName) {
        this.poId = poId;
