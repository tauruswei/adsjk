...
public enum BaseResultEnum implements ResultEnumType<Integer,String> {
    ...
    ABE_SETUP_FAIL(1101,"项目创建失败"),
    ABE_ENCRYPT_FAIL(1102,"加密失败"),
    ABE_KEY_GEN_FAIL(1103,"生成密钥失败"),
    ABE_DECRYPT_FAIL(1104,"解密失败"),
    SCD_CREATE_TEMPLATE_FAIL(1201,"创建模版失败"),
    SCD_SIGN_CERT_FAIL(1202,"签发证书失败"),
    SCD_VERIFY_FAIL(1203,"验证失败"),
    BLOCK_INVOKE_FAIL(1301,"invoke 失败"),
    BLOCK_QUERY_FAIL(1302,"query 失败"),
    BLOCK_SUBSCRIBE_FAIL(1303,"subscribe 失败"),
    BLOCK_UNSUBSCRIBE_FAIL(1304,"unsubscribe 失败"),
    ;
