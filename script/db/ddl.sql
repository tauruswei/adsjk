...
CREATE DATABASE IF NOT EXISTS `cosd` Character SET utf8 COLLATE utf8_bin;
...
CREATE TABLE `data_model` (
                              ...
                              `data` blob COMMENT '前端展示画布需要的json数据',
...
CREATE TABLE `data_project` (
                                ...
                                `provider_organ_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '协作方机构id保存三个',
...
CREATE TABLE `data_project_organ` (
                                      ...
                                      `organ_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '机构NAME',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC COMMENT='本地维护的组织信息';;

SET FOREIGN_KEY_CHECKS = 1;

LOCK TABLES `fusion_organ` WRITE;
/*!40000 ALTER TABLE `fusion_organ` DISABLE KEYS */;
INSERT INTO `fusion_organ` VALUES (1,'7aeeb3aa-75cc-4e40-8692-ea5fd5f5f9f0','CITIC','98E2104F2B75D3F1B03CABE884774A4B','http://192.168.2.150:8080','2022-06-29 14:57:14.344',0,'2022-06-29 06:57:14.439','2022-07-04 03:45:07.449'),(2,'3abfcb2a-8335-4bcc-b6f9-704a92e392fd','Node02','7F852120E99F8E351186AE92EF68C650','http://192.168.2.150:8081','2022-06-29 14:58:21.635',0,'2022-06-29 06:58:21.636','2022-07-04 05:30:16.289'),(3,'eb734dd0-773e-411b-ba29-794e41ba0e63','Node03','42CEC0EBB928AF1418FAD01D22FDDF42','http://192.168.2.150:8082','2022-06-29 19:28:38.090',0,'2022-06-29 11:28:38.093','2022-07-04 07:28:34.797');
/*!40000 ALTER TABLE `fusion_organ` ENABLE KEYS */;
UNLOCK TABLES;

DROP TABLE IF EXISTS `data_model_external`;
CREATE TABLE `data_model_external`  (
                             `file_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '文件id',
                             `file_source` int(12) NOT NULL COMMENT '文件来源',
                             `file_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文件地址',
                             `file_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文件名称',
